...
Printing is currently limited in choice of substate compatible with the 3D printing process.
...
The 3D part contained the microfluidic delivery channels, and was completed by adhering a gas permeable membrane of PDMS to enable diffusion of gas to the culture area using uncured PDMS as an adhesive.
The PDMS membrane components are attached to the 3D-printed network with an additional, thin layer of PDMS that was applied as an adhesive to the membrane, secured in position on the end of each pillar, and allowed to cure in place.
