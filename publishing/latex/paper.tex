...
The PDMS membranes were fabricated by spin coating PDMS on a silicon wafer at 900 RPM to a thickness of $\sim$100 $\mu$m and curing at $70\,^{\circ}$C for 30 minutes.
...
Briefly, polystyrene was dissolved in toluene to form a solution to which PtOEPK was mixed in before spin coating to a thin layer and allowing the toluene to evaporate.
...
The inlet tubing was placed in an open cone that was flooded with gas from a tank with a flow that exceed the vacuum flow so that the gas of interest was pulled into the inlet rather than room air due to the open connection.
