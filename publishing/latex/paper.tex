...
Senors were prepared as discussed previously \cite{Sinkala2010}. 
...
The intensity of the sensor was measured with via florescence microscopy and correlated to the concentration of oxygen with Stern-Volmer analysis (Fig.~\ref{fig2}).
...
The inlet tubing was placed in an open cone that was flooded with gas from a tank with a flow that exceed the vacuum flow so that the gas of interest is pulled into the inlet rather then room air due to the open connection.
