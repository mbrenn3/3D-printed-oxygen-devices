...
The device reaches steady state in 30 minutes and can then hold the oxygen level near 0\% indefinitely, while 95\% \ce{N2}, 5\% \ce{CO2} is pumped through the device. 
