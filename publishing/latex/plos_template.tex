...
This device provides convenient oxygen control within a standard culture format.
This device adds oxygen control will still allowing standard assays and imaging to occur, with the addition of a source of the gas of interest.
...
The device is also reusable. Typical PDMS microfluidic chips for the control of oxygen conditions are single use due to biological material fouling the membrane gas permeability. 
Due the the non-permanent application, the membranes can be easily pealed off and replaced with fresh ones allowing the device to be reused. 


Moving forward with additive manufacturing of microfluidic devices is desirable. 
3D printing higher levels of intricacy can be achieved without further complicating fabrication.
This allows any number of additional features to be added.
