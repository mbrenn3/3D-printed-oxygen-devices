...
A different gas condition can be used in each separate iteration of the 6-well unit allowing 6 technical replicates of up to 4 different gas conditions in one 24 well plate\ref{figure2}.

\subsection*{Bioverifcation}
The devices ability to control the gas environment is demonstrated with hypoxia influenced expression of mRNA in cancer cells\ref{fig3}.
