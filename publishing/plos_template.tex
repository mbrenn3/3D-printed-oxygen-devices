...
Recently 3D printing has emerged as a method for directly printing complete microfluidic devices \cite{Au2014, Chen2014} (spence). 
...
We demonstrate a device that nests into a 24 well culture plate.
...
Oxygen was measured with PtOEPK planar sensors that were fixed to the bottom of a 24well plate. 
The intensity of the sensor was measured and corellated to the concentration of oxygen with Stern-Volmer analysis (Figure \ref{piller-well-render-figure}.
Gas was perfused through the device with negitave pressure to eliminate bubbles.
The inlet tubing was placed in a cone with with a flow that exceded the vacuum flow rate.
All gas tanks used in the oxygen characterization were 5\% CO2 in addition to the desired gas mix in anticipation of cell culture experiments.
