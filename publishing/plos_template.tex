...
Recently 3D printing has emerged as a method for directly printing complete microfluidic devices \cite{Au2014, Chen2014}. 
...
Oxygen was measured with PtOEPK planar sensors that were fixed to the bottom of a 24 well plate. 
...
The inlet tubing was placed in a cone with with a flow that exceed the vacuum flow rate.
