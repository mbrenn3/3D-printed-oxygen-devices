% This m-file calulates the average and standard deviation for 6 colums(wells) of data from 3 runs


%loads data into matrices
...
save -ascii data/average.txt average % exports average to a file

% calulation for standard deviation 
...
save -ascii data/stdev.txt stdev  % exports stdev to a file
